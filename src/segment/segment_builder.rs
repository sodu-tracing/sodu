...
use crate::proto::types::{TraceIDOffset, SegmentMetadata, TraceIds};
...
impl SegmentBuilder {
    fn add_trace(&mut self,start_ts: u64, trace: Vec<&[u8]>){
    ...
    fn finish_chunk(&mut self){
        ...
        self.current_chunk_min_start_ts = u64::MIN;
        self.current_chunk_max_start_ts = u64::MAX;
    }
    ...
    fn finish_segment(&mut self,index: &HashMap<String, HashSet<u64>>) -> &Buffer {
        ...
        let chunks = mem::replace(&mut segment_metadata.chunks, RepeatedField::from(Vec::new()));
